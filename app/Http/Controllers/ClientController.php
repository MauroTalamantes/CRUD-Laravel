...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('client.index')->with('mensaje', 'Cliente creado exitosamente');
    }
    ...
    public function update(Request $request, Client $client)
    {
        ...
        $client->save();
        return redirect()->route('client.index')->with('mensaje', 'Cliente editado exitosamente');
    }
